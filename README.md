# 🎼 Partoche
Partoche is a terminal based pew pew map that feeds on [Melody logs](https://github.com/bonjourmalware/melody).

<center>
<img src="https://raw.githubusercontent.com/bonjourmalware/partoche/master/readme/partoche_demo.gif" />
</center>

Developed for Elasticsearch 7.x, not tested on later version.
...
# Quickstart
1) Check the `Requirements` section to make sure that everything is setup correctly
